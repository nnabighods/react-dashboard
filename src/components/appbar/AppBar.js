...
function AppBar(props) {
  ...
  return (
    ...
    <Container fluid className="p-0 d-flex flex-row flex-nowrap">
        <Navbar.Brand href="#" className="branding col-md-3 px-3 py-3 py-md-2 text-black d-flex justify-content-start">
        ...
        <div className="icons d-flex flex-row align-items-center gap-2 pe-md-3">
          ...
          <Link to="/" className="text-muted d-none d-md-block ms-3">Logout</Link>
        </div>
